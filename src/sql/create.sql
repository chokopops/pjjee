...
//INSERT INTO STUDENT(FIRSTNAME_STUDENT,LASTNAME_STUDENT, GROUP_STUDENT,ID_TUTOR,ID_DOC);
CREATE TABLE "STUDENT" (
    "ID_STUDENT" INTEGER NOT NULL AUTO_INCREMENT,
    "FIRSTNAME_STUDENT" VARCHAR(255),
    "LASTNAME_STUDENT" VARCHAR(255),
    "GROUP_STUDENT" VARCHAR(255),
    "ID_TUTOR" INTEGER,
    "ID_DOC" INTEGER,
...
CREATE TABLE "STAGE" (
    "ID_STAGE" INTEGER NOT NULL AUTO_INCREMENT,
    "DEBUT" DATETIME,
    "FIN" DATETIME,
    "MDS" VARCHAR(255),
    "NOTE_TECH" INTEGER,
